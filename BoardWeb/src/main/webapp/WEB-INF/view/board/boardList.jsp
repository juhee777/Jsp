...
<div class="center">
  <form action="boardList.do">
    <div class="row">
      <div class="col-sm-4">
        <select name="searchCondition" class="form-control"> <!-- name 파라메터 이름 -->
...
<div class="center">
  ...
  <a href="boardList.do?page=${paging.startPate-1 }&searchCondition=${searchCondition}&keyword=${keyword}">&laquo;</a>
  </c:if>
  
  <c:forEach var="p" begin="${paging.startPate }" end="${paging.endPage }">
         <a href="boardList.do?page=${p }&searchCondition=${searchCondition}&keyword=${keyword}" class=${p == paging.page ? 'active' : '' }>
           <c:out value="${p }"/></a>
  </c:forEach>
